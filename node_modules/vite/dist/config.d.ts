...
export interface Plugin extends Pick<UserConfig, 'alias' | 'transforms' | 'resolvers' | 'configureServer' | 'vueCompilerOptions' | 'vueCustomBlockTransforms' | 'rollupInputOptions' | 'rollupOutputOptions'> {
}
